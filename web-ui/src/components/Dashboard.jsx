...
export default function Dashboard({ user, onAnalyze, onNavigate }) {
    ...
    <div className="container" style={{ display: 'flex', flex: 1, gap: '2rem', padding: '2rem 0' }}>
      ...
      <aside style={{ width: '250px', display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
        ...
        <button
          ...
          style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', padding: '0.75rem 1rem', background: 'rgba(0, 242, 254, 0.1)', color: 'var(--neon-blue)', border: 'none', borderRadius: '8px', cursor: 'pointer', fontWeight: '500', textAlign: 'left' }}
        >
        ...
        <button
          ...
          style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', padding: '0.75rem 1rem', background: 'transparent', color: 'var(--text-muted)', border: 'none', borderRadius: '8px', cursor: 'pointer', textAlign: 'left' }}
        >
